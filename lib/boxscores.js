...
function generate(game) {
	...
	_.each(game.lastSnapshot.scoreboard.radiant.players, function(player) {
		getImageForHeroId(player.hero_id);
	});
...
function getImageForHeroId(heroId) {
	...
	winston.info("hero found: " + JSON.stringify(hero));
}
