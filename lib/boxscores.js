...
function generate(game) {
	...
	// TODO find some way to start downloading the team images and insert them here.
	// Also, make team names way smaller and move them over to make room for...
	// TODO add series data here.
	...
	// TODO This is where we're going to add the extra info on the x axis;
	// the 60m marker at the end, the 30m tick (and more if we're beyond 60)
    ...
    // }, ... ]
    // TODO double check this against a real game. 
    // in my example games it's not obvious which 
